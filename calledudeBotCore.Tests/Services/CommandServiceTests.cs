...
public class CommandServiceTests
{
    ...
    public async Task Bot_Responds_On_SpecialCommand_WithParameter()
    {
        ...
        await commandService.Handle(MessageObjectMother.CreateDiscordMessageWithContent(help.Name), CancellationToken.None);
    ...
    public async Task Bot_Responds_On_SpecialCommand_WithoutParameter()
    {
        ...
        await commandService.Handle(MessageObjectMother.CreateDiscordMessageWithContent(uptime.Name), CancellationToken.None);
